        ...
        mref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (sub.equals("LINUX PROGRAMMING")) {
                        float total = 0;
                        ...
                        if (sub.equals("DESIGN PATTERNS")) {
                            ...
                            if (sub.equals("CLOUD COMPUTING")) {
                                ...
                                if (sub.equals("INFORMATION RETREIVAL SYSTEM")) {
                                    float total = 0;
                                    for (DataSnapshot dataSnapshot2 : dataSnapshot1.getChildren()) {
                                        l++;
                                        String temp = dataSnapshot2.child("total").getValue().toString();
                                    ...
                                    if(sub.equals("MOBILE COMPUTING")) {
                                        ...
                                        if(sub.equals("DATA WAREHOUSE AND DATA MINING")) {
                                            float total = 0;
                                            for (DataSnapshot dataSnapshot2 : dataSnapshot1.getChildren()) {
                                                n++;
                                                String temp = dataSnapshot2.child("total").getValue().toString();
                ...
                Toast.makeText(Report.this, "The number of students given the rating are"+k, Toast.LENGTH_SHORT).show();
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Report.this, Graph.class);
